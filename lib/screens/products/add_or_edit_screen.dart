...
class AddOrEditScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    discountedPrice.text = productModel!.salePrice!.toStringAsFixed(2);
    discountPercentage.text = productModel!.discountPercentage!;
    stock.text = productModel!.stock!.toString();
    description.text = productModel!.description!.toString();
    notifier.imageUrl = notifier.imageUrl ?? productModel!.imageUrl;
    notifier.radioValue = notifier.radioValue ?? productModel!.scale!;
    notifier.dropValue =
        notifier.dropValue ?? productModel!.productCategoryName;
    String? uid = isEdit ? productModel?.id : const Uuid().v4();
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                    ...
                    isEdit
                        ? Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Dashboard > Products > ${productModel?.title} > Edit Product',
              ...
              ConditionalBuilder(
                condition: !provider.isAddOrEditLoading,
                builder: (context) => Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Expanded(
